...
dep_amqp_client                       = git_rmq rabbitmq-server $(current_rmq_ref) $(base_rmq_ref) master
...
dep_rabbit_common                     = git_rmq rabbitmq-server $(current_rmq_ref) $(base_rmq_ref) master
